...
INSERT INTO parent (f_name,f_nlty,f_htown,f_phoneno,f_occ,m_name,m_nlty,m_htown,m_phoneno,m_occ,parent_addr,std_no) values ('Samuel Wendolin','Gh','Holland city','0547272728','Dev','Julie Wendolin','Nig','Abuja','0547219187','Banker','Westlands-Legon','WEN2000');
INSERT INTO nextofkin (nok_name,nok_phoneno,std_no) values ('Green Wendolin','0234583736','WEN2000');

INSERT INTO house (h_addr,h_popu,h_lang,std_no) values ('Legon',5,'English/French','WEN2000');
INSERT INTO otherinfo (others,std_no) values ('None','WEN2000');